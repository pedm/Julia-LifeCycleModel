    ...
    for ixt=T:-1:1                                # Loop from time T-1 to 1
        ...
        for ixA = 1:1:numPointsA                  # points on asset grid
            ...
            for ixY = 1:1:numPointsY               # points on income grid
                ...
                negV, policyA1[ixt,ixA,ixY], policyC[ixt, ixA, ixY] = Value(params, Agrid, Ygrid, EV1, ixt, ixA, ixY)
                V[ixt, ixA, ixY]                                    = -negV
            end #ixY
...
function Value(params::Dict{String,Float64}, Agrid, Ygrid, EV1, ixt, ixA, ixY)
